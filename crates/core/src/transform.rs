...
//!
//! The samplers and the whole-tile-map resample live in `resample.rs`; this
//! file keeps the affine, the float lift/clear and the commit.
...
pub use resample::{Interp, resample_tile_map};
use resample::{sample_area, sample_bicubic, sample_bilinear, sample_nearest};
