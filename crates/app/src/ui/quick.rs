...
pub fn command_index() -> Vec<(&'static str, &'static str, AppCmd)> {
    ...
    vec![
        ...
        ("Zoom in", "View (Ctrl++ / PgUp)", ZoomIn),
        ("Zoom out", "View (Ctrl+- / PgDn)", ZoomOut),
        ("Zoom 200%", "View", ZoomTo(2.0)),
        ("Rotate view 90°", "View", RotateViewTo(90.0)),
        ("Rotate view 180°", "View", RotateViewTo(180.0)),
        ("Rotate view 270°", "View", RotateViewTo(270.0)),
